...
### Create new material by copying Fractal Master material (root plugin content folder), open it, select custom node named "fractal" (middle one), and type your Fractal Name in "code" segment like in screenshot
